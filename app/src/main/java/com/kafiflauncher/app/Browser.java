package com.kafiflauncher.app;

import android.app.*;
import android.os.*;
import android.view.*;
import android.widget.*;
import com.kafiflauncher.app.R;
	...
	@Override public void onResume()
		...
		if (GlobalVars.inputModeResult!=null)
			...
			if (GlobalVars.browserRequestInProgress==false)
				...
				new BrowserThreadGoTo().execute("http://www.google.com/custom?q=+"+GlobalVars.inputModeResult+"+&lr=lang_ar");
				}
				else
				{
